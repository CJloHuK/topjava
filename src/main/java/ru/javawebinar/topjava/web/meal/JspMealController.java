...
public class JspMealController extends MealAbstractRestController {
    ...
    public String updateMealPost(HttpServletRequest request) throws UnsupportedEncodingException {
    ...
    public String createMealPost(HttpServletRequest request) throws UnsupportedEncodingException {
        request.setCharacterEncoding("UTF-8");
        Meal meal = new Meal(
                LocalDateTime.parse(request.getParameter("dateTime")),
                request.getParameter("description"),
